...
def get_avatar_info_chart_by_json():
    ...
    attribute_data = json.load(open(input_path + '/attribute_data_for_pie_chart.json', 'r', encoding="utf-8"))
    category_data = json.load(open(input_path + '/category_data_for_pie_chart.json', 'r', encoding="utf-8"))
    sale_month_data = json.load(open(input_path + '/sale_month_data_for_pie_chart.json', 'r', encoding="utf-8"))
    sale_year_data = json.load(open(input_path + '/sale_year_data_for_pie_chart.json', 'r', encoding="utf-8"))
    body_data = json.load(open(input_path + '/body_data_for_pie_chart.json', 'r', encoding="utf-8"))
    chest_data = json.load(open(input_path + '/chest_data_for_pie_chart.json', 'r', encoding="utf-8"))
    body_and_chest_data = json.load(open(input_path + '/body_and_chest_data_for_pie_chart.json', 'r', encoding="utf-8"))
